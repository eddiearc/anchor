...
export function getAnchorHelp() {
  return [
    ...
    "",
    "R16 status:",
    "  Deterministic contract artifacts, git worktrees, fixture generation/evaluation/retry orchestration, Codex/Pi generator providers, Codex evaluator adapter, local task files (.anchor/tasks/*.yaml), CLI demo, JSONL event store, and permission guards are installed.",
