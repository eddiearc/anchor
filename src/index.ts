...
export function getAnchorHelp() {
  return [
    ...
    "  anchor --version",
    "  anchor run <task>",
    "  anchor run-wait <task|taskId> [--max-steps <n>]",
    "  anchor next <taskId>",
    ...
    "  anchor review <taskId> [--provider fixture|codex] [--verdict ready|needs_revision]",
    "  anchor workspace create <taskId>",
    "  anchor workspace status <taskId>",
    "  anchor workspace cleanup <taskId>",
    "  anchor generate <taskId> [--provider fixture|codex|pi]",
    "  anchor evaluate <taskId> [--provider fixture|codex|pi] [--verdict pass|fail]",
    "  anchor run-retry <taskId> [--provider fixture|codex|pi] [--generator-provider fixture|codex|pi] [--evaluator-provider fixture|codex|pi]",
    ...
    "  Quickstart commands: anchor run-wait <task>, anchor next <taskId>.",
    "  run-wait automatically advances agent-owned states until HUMAN, DONE, ABORT, an error, or --max-steps.",
    "  Task commands: anchor task create/list/show. Use anchor run-wait <task> for automation, anchor run <task> for manual control, or anchor plan --task <taskId> for an existing task.",
    ...
    "",
    "Configuration:",
    "  Anchor works without init.",
    "  Config is merged field-by-field in this order:",
    "    1. built-in defaults",
    ...
    "  Repo config is optional; create <git-root>/.anchor/config.yaml only for project-specific overrides.",
    "  Default provider comes from provider, or role-specific planner_provider/reviewer_provider/generator_provider/evaluator_provider.",
    "",
    "Store:",
