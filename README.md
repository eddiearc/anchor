...
```bash
# Install from GitHub source (Node.js >= 20 required)
...
`dist/` is generated by `pnpm build` and npm's package lifecycle. It is
included in published/installable tarballs, but it is not source and should not
be committed.
