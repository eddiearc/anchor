export const AGENT_ROLES = ["planner", "reviewer", "generator", "evaluator", "human", "system"];
const EVENT_SOURCE_PERMISSIONS = {
...
export function validateEventSource(role, eventType) {
    if (!isAgentRole(role)) {
        return {
            ok: false,
            code: "UNKNOWN_ROLE",
...
function validateGeneratorFiles(changedFiles, allowlist, denylist) {
