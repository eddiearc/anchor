...
test("codex evaluator runs fake script, reads verdict.json, and advances CHECK to DONE", async () => {
  ...
  await writeFile(fakeCodex, [
    ...
    "case \"$last\" in *\"You did not see how it was built\"*\"Run git diff against the task baseline\"*\"Open every evidence file\"*\"Missing evidence\"*\"specific, fixable findings\"*) ;; *) echo missing-anthropic-review-rules >&2; exit 3 ;; esac",
